...
if (num % 2 == 0) {
    ...
    console.log(`${num} is evev number`);
}
// eligibility for vote
if (num >= 18) {
    console.log(`${num} eligible for vote`);
}
else {
    console.log(`${num} is not eligible for vote`);
}
let num0 = ((10 + 5) * 3 - 2) / (4 % 3) - 7;
//student grade
let studentnumber = 60;
if (studentnumber >= 80) {
    console.log("student grade is A");
}
else if (studentnumber < 80 && studentnumber >= 70) {
    console.log('student grade is B');
}
else if (studentnumber < 70 && studentnumber >= 60) {
    console.log("student grade is C");
}
else if (studentnumber < 60 && studentnumber >= 50) {
...
switch (section) {
    case "A": {
        console.log("Your class timing every sunday 09AM-01PM");
        break;
    }
    case "B": {
        console.log("Your class timing every sunday 02PM-04PM");
        break;
    }
    default: {
